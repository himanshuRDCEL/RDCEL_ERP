...
using RDCELERP.StartJourney.Notification.Scheduler.StartJourneyNotification;

namespace RDCELERP.StartJourney.Notification.Scheduler
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            var serviceProvider = new ServiceCollection()
                ...
                .AddScoped<ISendStartJourneyNotification, SendStartJourneyNotification>()
            ...
            using (var notificationScheduler = serviceProvider.GetService<ISendStartJourneyNotification>())
            {
