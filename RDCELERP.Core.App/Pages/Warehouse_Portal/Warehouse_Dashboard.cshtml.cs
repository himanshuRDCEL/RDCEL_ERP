...
{
    public class Warehouse_DashboardModel : BasePageModel
    {
        ...
        public Warehouse_DashboardModel(ILogger<IndexModel> logger, IUserManager userManager, RDCELERP.DAL.Entities.Digi2l_DevContext context, IOptions<ApplicationSettings> config, IEVCManager eVCManager)
        : base(config)
