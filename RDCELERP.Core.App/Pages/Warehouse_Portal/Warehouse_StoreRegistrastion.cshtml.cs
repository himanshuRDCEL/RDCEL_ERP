...
{
    public class Warehouse_StoreRegistrastionModel : CrudBasePageModel
    {
        ...
        #endregion
        public Warehouse_StoreRegistrastionModel(Digi2l_DevContext context, IOptions<ApplicationSettings> config, CustomDataProtection protector, IEVCManager EVCManager,IStateRepository stateRepository,ICityRepository cityRepository,IEVCPartnerRepository eVCPartnerRepository) : base(config, protector)
        {
