...
{
    public class Warehouse_PartnerListModel : BasePageModel
    {
        ...
        # region Constructor
        public Warehouse_PartnerListModel(RDCELERP.DAL.Entities.Digi2l_DevContext context, IOptions<ApplicationSettings> config, IEVCManager EVCManager, CustomDataProtection protector) : base(config)
        {
