...
{
    public class OrderdetailsViewPageForWarehouse_PortALModel : BasePageModel
    {
        ...
        #region Constructor
        public OrderdetailsViewPageForWarehouse_PortALModel(IOptions<ApplicationSettings> config, ILogisticManager logisticManager, ILogisticsRepository logisticsRepository, INotificationManager notificationManager, RDCELERP.DAL.Entities.Digi2l_DevContext context, IEVCManager evcManager) : base(config)
        {
