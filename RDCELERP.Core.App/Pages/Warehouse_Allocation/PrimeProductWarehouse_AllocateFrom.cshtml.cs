...
namespace RDCELERP.Core.App.Pages.Warehouse_Allocation
{
    public class PrimeProductWarehouse_AllocateFromModel : BasePageModel
    {
            ...
            if (OId > 0)
            {
                ...
                {                    
                    ...
                    else
                    {
                        ...
                        text = "Warehouse not found for this order ";
                    }
                ...
                {
                    return RedirectToPage("Warehouse_Allocation/Not_Allocated");
                }
                var baseUrl = _config.Value.BaseURL;
                PageRedirectionURL = baseUrl + "Warehouse_Allocation/Not_Allocated";
                return Page();
            }
            else
            {
