...
namespace RDCELERP.Core.App.Pages.LGCOrderTracking
{
    public class LGCDriverDetailsModel : BasePageModel
    {
        ...
        public IActionResult OnGet(string? DriverDetailsId = null, string? ServicePartnerId = null, int? StatusId = null)
        {
            int userId = 0;
            ...
            if(StatusId != null && StatusId > 0){Statusid = StatusId; }
            ...
            lGCOrderViewModel = new LGCOrderViewModel();
            lGCOrderViewModel.driverlistVM = new DriverListViewModel();
