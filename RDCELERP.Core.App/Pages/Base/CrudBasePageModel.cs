...
{
    public class CrudBasePageModel:PageModel
    {
        ...
        public CrudBasePageModel(IOptions<ApplicationSettings> baseConfig, CustomDataProtection protector)
        {
        ...
        public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
        {
            ...
            if (_loginSession != null)
            {
                ...
                {
                    if (context.ActionDescriptor.ViewEnginePath != "/Dashboard")
                    {
                        ////url for server
                        ...
                        AccessRuleViewModel accessRule = new AccessRuleViewModel();
                        //RoleAccessViewModel roleAccessVM = _loginSession.RoleViewModel.RoleAccessViewModelList.FirstOrDefault(x => x.ActionUrl.ToLower().Equals(urlforcheck.ToLower()));
                        RoleAccessViewModel roleAccessVM = _loginSession.RoleViewModel.RoleAccessViewModelList.FirstOrDefault(x => x.ActionUrl != null && x.ActionUrl.ToLower().Contains(urlforcheck.ToLower()));
