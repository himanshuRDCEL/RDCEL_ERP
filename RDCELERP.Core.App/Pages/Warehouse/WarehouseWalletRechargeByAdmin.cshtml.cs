...
namespace RDCELERP.Core.App.Pages.Warehouse_Portal
{
    public class WarehouseWalletRechargeByAdminModel : BasePageModel
    {
        ...
        public WarehouseWalletRechargeByAdminModel(RDCELERP.DAL.Entities.Digi2l_DevContext context, IOptions<ApplicationSettings> config, IEVCManager EVCManager, ILogging logging, IWebHostEnvironment webHostEnvironment, ICreditRequestRepository creditRequestRepository)
      : base(config)
        {
        ...
        [BindProperty(SupportsGet = true)]
        public IList<Warehouse_ApprovedModel> EVC_ApprovedModels { get; set; }
        ...
        public IActionResult OnPostAsync(IFormFile? InvoiceImage)
        {
            try
            {
                ...
                {
                    return RedirectToPage("./AddWarehouseWalletBalance/");
                }
