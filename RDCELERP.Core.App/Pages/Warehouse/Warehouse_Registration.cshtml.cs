...
namespace RDCELERP.Core.App.Pages.Warehouse
{
    public class Warehouse_Registration : CrudBasePageModel
    {
                ...
                if (evc_RegistrationModel != null)
                {
                    ...
                    if (result == 2)
                    {
                        if (AFlag == 1)
                        {
                            ...
                            return RedirectToPage("Warehouse_NotApproved");

                        }
                        if (AFlag == 2)
                        {
                            ViewData["Message"] = "Update Successfully";
                            return RedirectToPage("Warehouse_Approved");
                        }
                    }
                    if (result == 1)
                    {
                    ...
                    if (result == 0)
                    {
                        ...
                        return RedirectToPage("Warehouse_Registration");
                    }
        ...
        #region AutoFill To Get Warehouse Employee List Added By PJ
        ...
        #region AutoFill To Get Warehouse State List Added By PJ
        ...
        #region AutoFill To Get Warehouse City List Added By PJ
        ...
        #endregion
        #region AutoFill To Get Warehouse Pincode List Added By priyanshi
