...
{
    public class Warehouse_PartnerAddListofPincdeModel : BasePageModel
    {
        ...
        #region Constructor
        public Warehouse_PartnerAddListofPincdeModel(IOptions<ApplicationSettings> config, IEVCPartnerRepository eVCPartnerRepository, IProductCategoryManager productCategoryManager, ITemplateConfigurationRepository configurationRepository, IEVCManager eVCManager, Digi2l_DevContext context) : base(config)
        {
        ...
        public IActionResult OnPostAsync()
        {
            ...
            eVC_StoreRegistrastionViewModels.IsApprove = true;
                ...
                if (result == 0)
                {
                 ...
                 return RedirectToPage("Warehouse_PartnerListforAdmin");
            }
            else if (result == 1)
                {
                ...
                {
                    Message = "Warehouse Data not fount";
