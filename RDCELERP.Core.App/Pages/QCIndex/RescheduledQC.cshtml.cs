    ...
    public class RescheduledQCModel : BasePageModel
    {
       ...
       : base(config)
        ...
        public IActionResult OnGetSearchRegdNo(string term)
        {
            ...
            var data = _context.TblOrderQcs.Include(x=>x.OrderTrans).ThenInclude(x=>x.Exchange)
            .Where(x => x.OrderTrans != null && x.OrderTrans.Exchange != null && x.OrderTrans.RegdNo.Contains(term)
